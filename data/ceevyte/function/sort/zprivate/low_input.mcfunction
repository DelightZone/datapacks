...
execute if score #sort.zprivate.input_length ceevyte matches 1 run function ceevyte:sort/zprivate/error/lesser_than_two
...
data remove storage ceevyte sort.zprivate.input[0]
scoreboard players set #sort.zprivate.input_length ceevyte 0
execute if data storage ceevyte sort.zprivate.compare.a.value if data storage ceevyte sort.zprivate.compare.b.value run scoreboard players set #sort.zprivate.input_length ceevyte 1
execute if score #sort.zprivate.input_length ceevyte matches 0 run function ceevyte:sort/zprivate/error/input.invalid_value
execute if score #sort.zprivate.input_length ceevyte matches 0 run return 0
...
execute if score #sort.zprivate.compare.a ceevyte > #sort.zprivate.compare.b ceevyte run function ceevyte:sort/zprivate/low_input/nested_execute_0
